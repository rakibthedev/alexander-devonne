...
export default function EditProfile({cancelEdit}) {
    ...
    const [value, setValue] = useState({
        ...
        country: loggedUserData.country,
        birthdate_day: loggedUserData.birthdate_day,
        birthdate_month: loggedUserData.birthdate_month,
        birthdate_year: loggedUserData.birthdate_year
    });
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(checkErrors()).length === 0) {
            ...
            try{
                ...
                const res = await fetch(`${process.env.NEXT_PUBLIC_WORDPRESS_SITE_URL}/wp-json/rakib/v2/update-profile`, {
                    method: 'POST',
                    headers: {
                ...
                if (res.ok) {
                    ...
                    const structuredUserData = {
                        ...
                        subscribe_to_newsletter: loggedUserData.subscribe_to_newsletter,     
                   ...
                   setLoggedUserData(structuredUserData);  
                    ...
                    setNotification("Opps! something went wrong updating data");
        ...
        <div>
            <form onSubmit={handleSubmit}>
                <div className="custom__form flex flex-col gap-4">
                    <h2 className='text-xs uppercase mb-4'>Edit Your Personal Information</h2>
                    ...
                    {/* Gender Input  */}
                        <div className="input__group relative h-12 w-full">
                            <select
                                ...
                                name="gender"                                
                                value={value.gender || ''}
                                className={`custom__select ${value.gender ? 'active' : ''} bg-white absolute top-1 left-0 form__input w-full h-12 outline-none text-xs leading-5`}
                        ...
                        <div className={`input__group relative w-full ${errors.first_name ? "h-[72px]" : "h-12"}`}>
                            <input
                                ...
                                id="first_name"
                                name="first_name"
                                className={`absolute form__input ${errors.first_name ? "bg-[#00448a33]" : "bg-white w-full"} ${value.first_name ? "active" : ""} h-12 outline-none text-xs leading-5`}
                                type="text"
                                autoComplete="off"
                        ...
                        <div className={`input__group relative w-full ${errors.last_name ? "h-[72px]" : "h-12"}`}>
                            <input
                                ...
                                id="last_name"
                                name="last_name"
                                className={`absolute form__input ${errors.last_name ? "bg-[#00448a33]" : "bg-white w-full"} ${value.last_name ? "active" : ""} h-12 outline-none text-xs leading-5`}
                                type="text"
                                autoComplete="off"
                    ...
                    <div className={`flex flex-col lg:flex-row items-stretch gap-2 w-full`}>
                        ...
                        <div className={`input__group relative w-full ${errors.email ? "h-[72px]" : "h-12"}`}>
                            <input
                                ...
                                id="email"
                                name="email"
                                className={`absolute form__input ${errors.email ? "bg-[#00448a33]" : "bg-white w-full"} ${value.email ? "active" : ""} h-12 outline-none text-xs leading-5`}
                                type="text"
                                autoComplete="off"
                                value={value.email || ''}
                            />
                        ...
                        {/* Phone Number Input */}
                        <div className={`input__group relative w-full ${errors.phone_number ? "h-[72px]" : "h-12"}`}>
                            <input
                                onChange={handleInputChange}
                                id="phone_number"
                                name="phone_number"
                                className={`absolute form__input ${errors.phone_number ? "bg-[#00448a33]" : "bg-white w-full"} ${value.phone_number ? "active" : ""} h-12 outline-none text-xs leading-5`}
                                type="tel"
                                autoComplete="off"
                                value={value.phone_number || ''}
                            />
                            <label className="form__label text-xs absolute capitalize select-none" htmlFor="phone_number">
                                Phone Number
                            </label>
                            {errors.phone_number && !isInitialRender && (
                                <div className="absolute bottom-4 left-0 w-full text-[#196cb1] text-xs">
                                    {errors.phone_number}
                                </div>
                            )}
                    ...
                    <div className={`flex flex-col lg:flex-row items-stretch gap-2 w-full`}>
                        {/* Country Input */}
                        <div className="input__group relative h-12 w-full flex-[34%]">
                            <select
                                id="country"
                                name="country"
                                value={value.country || 'US'}
                                className={`custom__select bg-white absolute top-1 left-0 form__input active w-full h-12 outline-none text-xs leading-5`}
                                onChange={handleInputChange}
                            >
                                <option value="" hidden></option>
                        ...
                        <div className={`flex flex-col lg:flex-row items-stretch gap-2 w-full flex-[66%]`}>
                            {/* BOD Day Input */}
                            <div className="input__group relative h-12 w-full">
                                <select
                                    id="birthdate_day"
                                    ...
                                    className={`custom__select ${value.birthdate_day ? 'active' : ''} bg-white absolute top-1 left-0 form__input w-full h-12 outline-none text-xs leading-5`}
                                    onChange={handleInputChange}
                                >
                                    <option value="" hidden></option>
                            ...
                            <div className="input__group relative h-12 w-full">
                                <select
                                    ...
                                    className={`custom__select ${value.birthdate_month ? 'active' : ''} bg-white absolute top-1 left-0 form__input w-full h-12 outline-none text-xs leading-5`}
                                    onChange={handleInputChange}
                                >
                                    <option value="" hidden></option>
                                    <option value="01">01</option>
                            ...
                            <div className="input__group relative h-12 w-full">
                                <select
                                    ...
                                    className={`custom__select ${value.birthdate_year ? 'active' : ''} bg-white absolute top-1 left-0 form__input w-full h-12 outline-none text-xs leading-5`}
                                    onChange={handleInputChange}
                                >
                                    <option value="" hidden></option>
